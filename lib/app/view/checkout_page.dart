...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  final paymentMethods = [
    {'id': 'Tarjeta', 'label': 'Tarjeta', 'sublabel': 'Stripe', 'icon': Icons.credit_card},
    {'id': 'SPEI', 'label': 'SPEI', 'sublabel': 'Transferencia', 'icon': Icons.account_balance},
    {'id': 'Efectivo', 'label': 'Efectivo', 'sublabel': 'Oxxo Pay', 'icon': Icons.money},
  ];
  ...
  Widget _buildServiceDetails() {
    return Column(
      ...
      children: [
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Hora de Inicio', style: TextStyle(color: Colors.grey)),
                  const SizedBox(height: 8),
                  GestureDetector(
                    onTap: _pickTime,
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.access_time, color: Color(0xFFE01D25), size: 18),
                          const SizedBox(width: 10),
                          Text(
        ...
        const SizedBox(height: 16),
        const Text('Dirección del Evento', style: TextStyle(color: Colors.grey)),
        const SizedBox(height: 8),
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 14),
          decoration: BoxDecoration(
              ...
              const Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Mapa (Google Maps)', style: TextStyle(color: Colors.grey)),
                  ],
                ),
              ),
              const Center(
                child: Icon(Icons.location_pin, color: Color(0xFFE01D25), size: 40),
              ),
              Positioned(
                bottom: 12,
                right: 12,
          ...
          children: [
            ...
            Row(
              children: const [
                ...
                Text(
                  'Seguro',
                  style: TextStyle(color: Color(0xFFE01D25), fontWeight: FontWeight.w500),
                ),
              ],
            ),
          ],
                    ...
                    children: [
                      Stack(
                        children: [
                          Icon(
                            ...
                            color: isSelected ? const Color(0xFFE01D25) : Colors.grey,
                            size: 28,
                          ),
                          if (isSelected)
                            const Positioned(
                              right: -4,
                              top: -4,
                              child: Icon(Icons.check_circle, color: Color(0xFFE01D25), size: 14),
                            ),
                        ],
                      ),
                      const SizedBox(height: 8),
                      Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 13,
                          color: isSelected ? const Color(0xFFE01D25) : const Color(0xFF010302),
                        ),
                      ),
                      Text(
  ...
  void _confirmPayment() {
    // Aquí se enviaría la solicitud a la base de datos
    // Tabla: solicitudes
    // - cliente_usuario_id
    ...
    // También insertar en items_solicitud
    ...
    showDialog<void>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: const [
            Icon(Icons.check_circle, color: Color(0xFF4CAF50), size: 80),
            SizedBox(height: 20),
            Text(
            ...
            SizedBox(height: 10),
            Text(
              'Tu solicitud ha sido enviada al proveedor. Te notificaremos cuando sea aceptada.',
